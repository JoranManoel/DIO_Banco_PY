...
Este é um projeto simples de um **Sistema Bancário** desenvolvido em Python durante o bootcamp da DIO. Ele permite criar contas, realizar depósitos, saques e consultar o extrato.
